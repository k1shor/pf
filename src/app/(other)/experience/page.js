            ...
            >
              ...
              <div className="space-y-4 text-lg">
                <p className="flex items-center gap-2">
                  <FaEnvelope className="text-blue-600" /> kishor@indexithub.com
                </p>
                <p className="flex items-center gap-2">
                  <FaPhone className="text-green-600" /> +977-9860113289
                </p>
                <p className="flex items-center gap-2">
                  <FaGithub className="text-gray-800 dark:text-white" />
                  <Link href="https://github.com/k1shor" target="_blank">k1shor</Link>
                </p>
                <p className="flex items-center gap-2">
                  <FaLinkedin className="text-sky-700" />
                  <Link href="https://linkedin.com/in/kishor-munikar-94aa4937/" target="_blank">Connect </Link>
                </p>
              </div>
            </motion.section>
